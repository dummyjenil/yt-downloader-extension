...
export async function setDNRHeadersForClient(
  clientName: "WEB" | "ANDROID_VR" | "TV"
) {
  dnrQueue = dnrQueue
    .then(async () => {
      let userAgent = ""
      ...
      if (clientName === "WEB") {
        ...
        userAgent =
          "Mozilla/5.0 (ChromiumStylePlatform; Widevine) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
        clientNameHeader = "7"
